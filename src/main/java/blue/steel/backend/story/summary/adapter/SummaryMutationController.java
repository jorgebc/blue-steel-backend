...
public class SummaryMutationController {
  ...
  public SummaryMutationController(
      UseCase<CreateSummaryUseCaseInput, CreateSummaryUseCaseOutput> createCampaignSummary) {
    this.createCampaignSummary = createCampaignSummary;
  }
